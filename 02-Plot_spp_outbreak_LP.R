...
spp.plot <- c("WEWP", "RCKI", "AMRO", "DEJU")
...
p <- ggdraw() +
  draw_plot(pp1, x = 0, y = 0.75, width = 1, height = 0.25) +
  draw_plot(pp2, x = 0, y = 0.5, width = 1, height = 0.25) +
  draw_plot(pp3, x = 0, y = 0.25, width = 1, height = 0.25) +
  draw_plot(pp4, x = 0, y = 0, width = 1, height = 0.25)

p <- ggdraw() +
  draw_plot(p, x = 0.05, y = 0.05, width = 0.95, height = 0.95) +
  draw_plot_label(c("Occupancy", "Percent dead conifer", "Years since outbreak"),
                  x = c(0, 0.2, 0.67), y = c(0.47, 0.05, 0.05),
                  angle = c(90, 0, 0), size = c(20, 15, 15), hjust = c(0, 0, 0))

save_plot(str_c("Plot_spp_outbreak_", stratum, "1.tiff"), p, ncol = 2, nrow = 3, dpi = 200)

##____ Group 2 - supported linear (only) relations with YSO ____##
spp.plot <- c("MODO", "OSFL", "TOSO", "HETH", "LISP", "WETA")
...
save_plot(str_c("Plot_spp_outbreak_", stratum, "2.tiff"), p, ncol = 4, nrow = 3, dpi = 200)

##____ Group 3 - supported quadratic relations with YSO but not % dead ____##
spp.plot <- c("GTTO", "YRWA")
...
p <- ggdraw() +
  draw_plot(pp1, x = 0, y = 0.5, width = 1, height = 0.5) +
  draw_plot(pp2, x = 0, y = 0, width = 1, height = 0.5)
...
save_plot(str_c("Plot_spp_outbreak_", stratum, "3.tiff"), p, ncol = 2, nrow = 2, dpi = 200)
