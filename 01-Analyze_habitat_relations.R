...
parameters <- c("omega", "rho.ab", "rho.bd",
                ...
                "Betad.TWIP", "sigma.Betad.TWIP", "Betad.TWI", "sigma.Betad.TWI", "Betad.heatload", "sigma.Betad.heatload",
                ...
                "d0", "b0", "a0",
                "bd.pdead", "bd.TWIP", "bd.TWI", "bd.heatload",
                "bd.RDens", "bd.WILD", "bd.RCovAS", "bd.RCovES", "bd.RCovPine",
